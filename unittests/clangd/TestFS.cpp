...
MockCompilationDatabase::MockCompilationDatabase(StringRef Directory, StringRef RelPathPrefix)
    : ExtraClangFlags({"-ffreestanding"}), Directory(Directory), RelPathPrefix(RelPathPrefix) {
